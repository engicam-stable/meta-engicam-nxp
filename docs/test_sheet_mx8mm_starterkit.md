...
Close J_USB1 and B_M jumpers and leave nSD_BOOT open 
to enable serial download. Connect the board with the
source machine (i.e. the machine you are downloading
the images from) by using the board's OTG header (J25).
...
|   N/A  |        Ethernet 1 (J19)       | see [note1](#note-1)
...
|   OK   |      UART 232 ttymxc0 (J21)   | see [note2](#note-2)
|   OK   |      UART 485 ttymxc2 (J22)   | see [note3](#note-3)
|   OK   |         Linux Console (J26)   |
|   OK   |              WIFI             | see [note4](#note-4)
|   OK   |           BLUETOOTH           | see [note5](#note-5)
|   OK   |           MIPI-CSI (J18)      | see [note6](#note-6)
...
|   N/A  |      CAN 0/CAN 1 (J23/J24)    | see [note12](#note-12)
|   OK   |              PCIe             | see [note13](#note-13)
|   OK   |              GPU              | see [note14](#note-14)
|   OK   |              VPU              | see [note15](#note-15)
...
First configure the whole topology to have same format and frame size.
Here we see we have different formats through several devices:
