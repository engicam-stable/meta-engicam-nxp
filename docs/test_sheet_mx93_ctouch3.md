...
| [Sdcard Enviroment saving](#sdcard-environment-saving)                        |   TBT   |
| [Ethernet](#ethernet)                                                         |   OK    |
| [Boot from eMMC](#boot-from-emmc)                                             |   OK    |
| [Boot from sdcard](#boot-from-sdcard)                                         |   TBT   |
| [USB](#usb)                                                                   |   OK    |
...
|   OK   | Ethernet 1 (J15 - iMX93 FULL) | see [note1](#note-1)
...
|   TBT  |     UART 232 ttyLP7 (J18)     | see [note2](#note-2)
|   TBT  |     UART 485 ttyLP4 (J18)     | see [note3](#note-3)
|   OK   |      Linux Console (J13)      |
|   OK   |              WIFI             | see [note4](#note-4)
|   TBT  |           BLUETOOTH           | see [note5](#note-5)
|   OK   |              RTC              | see [note6](#note-6)
|   OK   |             Reboot            |
|   OK   |             LVDS (J3)         | see [note7](#note-7)
|   OK   |           Backlight           | see [note8](#note-8)
|   OK   |          Touchscreen          | see [note9](#note-9)
|   TBT  |          Audio (J20)          | see [note10](#note-10)
|   N/A  |           HDMI (J2)           |
|   TBT  |       CAN 0/CAN 1 (J19)       | see [note11](#note-11)
...
Connect TX/RX PIN connector J18 to the UART 232 port
